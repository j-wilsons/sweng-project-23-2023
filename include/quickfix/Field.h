...
: FieldBase( field, "" ) {}
  ...
  char getValue() const QUICKFIX_THROW( IncorrectDataFormat )
    { try
...
: FieldBase( field, "" ) {}
  ...
  double getValue() const QUICKFIX_THROW( IncorrectDataFormat )
    { try
...
: FieldBase( field, "" ) {}
  ...
  int getValue() const QUICKFIX_THROW( IncorrectDataFormat )
    { try
...
: FieldBase( field, "" ) {}
  ...
  bool getValue() const QUICKFIX_THROW( IncorrectDataFormat )
    { try
...
: FieldBase( field, UtcTimeStampConvertor::convert( UtcTimeStamp(), precision ) ) {}
  ...
  UtcTimeStamp getValue() const QUICKFIX_THROW( IncorrectDataFormat )
    { try
...
: FieldBase( field, UtcDateConvertor::convert( UtcDate() ) ) {}
  ...
  UtcDate getValue() const QUICKFIX_THROW( IncorrectDataFormat )
    { try
...
: FieldBase( field, UtcTimeOnlyConvertor::convert( UtcTimeOnly(), precision ) ) {}
  ...
  UtcTimeOnly getValue() const QUICKFIX_THROW( IncorrectDataFormat )
    { try
