...
const IBMnums = [33,55,66,11,22,33,23,44,66,77,88,44,55,66,33,44,55,66,7,77]
const nikeNums = [11,22,55,11,22,66,99,44,55,66,88,33,44,55,33,22,55,66,77,99]
const amzNums = [22,44,55,66,11,22,55,88,77,66,44,33,44,55,99,77,88,99,11,22]
const teslaNums = [77,88,99,66,55,88,99,22,33,44,66,77,88,55,66,77,44,44,55,66]
const numLabels = ["test","test","test","test","test","test","test","test","test","test","test","test","test","test","test","test","test","test","test","test"]
...
useEffect(() => {
  ...
  return (
   ...
   <div className="graph">
    <ApexChart data={dataNums} data2={IBMnums} data3={amzNums} data4={teslaNums} dLabels={numLabels}></ApexChart>
    </div>
    <div className="right-pos">
    <Container fluid >
      <Row >
        <Col className="container-pos">
          Current equities</Col>
