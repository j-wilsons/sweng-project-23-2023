...
public:
  ...
  Group& getGroup( unsigned num, FIX::Group& group ) const QUICKFIX_THROW( FieldNotFound )
  { group.clear();
...
QUICKFIX_THROW( MessageParseError )
{
